...
class Report_Generator {
    ...
    public static function generate_and_send( $response, $download = false ) {
        ...
        $pdf->Cell(
            0,
            10,
            'Generated on ' . gmdate( 'Y-m-d H:i:s' ) . ' (UTC)',
            0,
            1,
            'C'
        );
        ...
        $pdf->Cell(
            0,
            8,
            'Website: ' . get_bloginfo( 'name' ) . ' (' . site_url() . ')',
            0,
            1
        );
        $pdf->Cell(
            0,
            8,
            'Total Files Scanned: ' . number_format( $processed ),
            0,
            1
        );
        if ( $issues > 0 ) {
            ...
            $pdf->Cell(
                0,
                8,
                'Malware Threats Detected: ' . $issues,
                0,
                1
            );
        } else {
            ...
            $pdf->Cell(
                0,
                8,
                'Malware Threats Detected: 0 (Site is Clean)',
                0,
                1
            );
        }
